...
- Add cursor pagination to recon engine overview & data screens ([#5154](https://github.com/juspay/hyperswitch-control-center/pull/5154)) ([`275abab`](https://github.com/juspay/hyperswitch-control-center/commit/275abab4cdce0a337cf7e8d72de3d299eadf653e))
- Use staging entry aggregate api for stat card counts ([#5174](https://github.com/juspay/hyperswitch-control-center/pull/5174)) ([`f06942e`](https://github.com/juspay/hyperswitch-control-center/commit/f06942ecf1e6faf31721b0d74521bd44a28da501))
- Integrate aggregate API for recon engine overview graphs ([#5197](https://github.com/juspay/hyperswitch-control-center/pull/5197)) ([`a66eab7`](https://github.com/juspay/hyperswitch-control-center/commit/a66eab7774ba555f7d676a6c30048c62080294ae))

### Bug Fixes

- Add authentication analytics heading spacing ([#5168](https://github.com/juspay/hyperswitch-control-center/pull/5168)) ([`2e7fe7e`](https://github.com/juspay/hyperswitch-control-center/commit/2e7fe7ea8577d05324480dfa25cfd0a0fe1abe91))
- Handle empty copy values in transaction tables ([#5165](https://github.com/juspay/hyperswitch-control-center/pull/5165)) ([`3cd97af`](https://github.com/juspay/hyperswitch-control-center/commit/3cd97afea377485398ae5692ad1392cbdadbac1e))
- Increase recon engine file upload size limit to 25MB ([#5183](https://github.com/juspay/hyperswitch-control-center/pull/5183)) ([`5e5fd92`](https://github.com/juspay/hyperswitch-control-center/commit/5e5fd9254ddd4029828ccabb42750dd85fdb3ec0))

### Miscellaneous Tasks

- **ci:** Rename ready-for-review label to required-checks-passed ([#5192](https://github.com/juspay/hyperswitch-control-center/pull/5192)) ([`5a78c1a`](https://github.com/juspay/hyperswitch-control-center/commit/5a78c1ad927fc96752714d7b553c44d057a63ae2))

**Full Changelog:** [`2026.07.16.0...2026.07.16.1`](https://github.com/juspay/hyperswitch-control-center/compare/2026.07.16.0...2026.07.16.1)
...
- Add payment capture form for orders ([#5001](https://github.com/juspay/hyperswitch-control-center/pull/5001)) ([`499a992`](https://github.com/juspay/hyperswitch-control-center/commit/499a99253734830e8d41f38fec7ab580f560a354))
- Visited row - highlight visited columns feature ([#4785](https://github.com/juspay/hyperswitch-control-center/pull/4785)) ([`53910b7`](https://github.com/juspay/hyperswitch-control-center/commit/53910b7bdfdab4334055fbaa7e0542256a965435))

### Bug Fixes

- Use Blend Toast and error code mapping for clone connector ([#5161](https://github.com/juspay/hyperswitch-control-center/pull/5161)) ([`3cbf5d0`](https://github.com/juspay/hyperswitch-control-center/commit/3cbf5d0bdb6ec3800306fd82f27a4eaa01f7748e))
- Gate V1 Hyperswitch API key header behind feature flag ([#5163](https://github.com/juspay/hyperswitch-control-center/pull/5163)) ([`ee8f0fc`](https://github.com/juspay/hyperswitch-control-center/commit/ee8f0fc7b70f7be787021848f29a1336688040fd))

### Refactors

- Remove stale profile management hint ([#5151](https://github.com/juspay/hyperswitch-control-center/pull/5151)) ([`6df19e2`](https://github.com/juspay/hyperswitch-control-center/commit/6df19e275891b0675464dc2e5ff479d8fe638a4d))

**Full Changelog:** [`2026.07.14.0...2026.07.15.0`](https://github.com/juspay/hyperswitch-control-center/compare/2026.07.14.0...2026.07.15.0)
...
- Implement analytics-driven payment listing with a new API endpoint ([#4225](https://github.com/juspay/hyperswitch-control-center/pull/4225)) ([`13f852f`](https://github.com/juspay/hyperswitch-control-center/commit/13f852f7797a7feec9d791ca78fee100b9fcde60))

### Miscellaneous Tasks

- Enable network tokenization based on feature flag ([#4350](https://github.com/juspay/hyperswitch-control-center/pull/4350)) ([`5ee1a4e`](https://github.com/juspay/hyperswitch-control-center/commit/5ee1a4ecc2f6ef0c681cc2ca0e8d4c23a96727ea))

**Full Changelog:** [`2026.03.13.0...2026.03.16.0`](https://github.com/juspay/hyperswitch-control-center/compare/2026.03.13.0...2026.03.16.0)
...
- Enable themes for embeddable components ([#4201](https://github.com/juspay/hyperswitch-control-center/pull/4201)) ([`20a705c`](https://github.com/juspay/hyperswitch-control-center/commit/20a705caee1d08842dc25cceaa37e967b96ae047))
- Add loading on manage users ([#4290](https://github.com/juspay/hyperswitch-control-center/pull/4290)) ([`25af893`](https://github.com/juspay/hyperswitch-control-center/commit/25af893a3e0dce50c894b6a5c212c8ba2076490e))

### Bug Fixes

- **global-search:** Correct dispute redirect path from search results ([#4287](https://github.com/juspay/hyperswitch-control-center/pull/4287)) ([`1feadc6`](https://github.com/juspay/hyperswitch-control-center/commit/1feadc675ccdd5b527d16fbf452dc1bb620ef310))
- Handle long role name overflow on invite page ([#4283](https://github.com/juspay/hyperswitch-control-center/pull/4283)) ([`478030f`](https://github.com/juspay/hyperswitch-control-center/commit/478030f3a64f50909c82101e7fa5b7469c214334))
- Sort recon engine transactions list ([#4299](https://github.com/juspay/hyperswitch-control-center/pull/4299)) ([`32b984d`](https://github.com/juspay/hyperswitch-control-center/commit/32b984d496bdd1c8e0743b8f2bc0afaeec60ada4))
- Preserve disabled state when updating connector ([#4281](https://github.com/juspay/hyperswitch-control-center/pull/4281)) ([`a58f07d`](https://github.com/juspay/hyperswitch-control-center/commit/a58f07d1ab9973d6d7550fe7f610dc1f1e2d9c35))
- Apple pay fields missing in braintree fix ([#4284](https://github.com/juspay/hyperswitch-control-center/pull/4284)) ([`ad13a9c`](https://github.com/juspay/hyperswitch-control-center/commit/ad13a9cfc93fc4d2179c3892577c9417e45d0c0c))
- Handle email special characters in user details page URL ([#4286](https://github.com/juspay/hyperswitch-control-center/pull/4286)) ([`07a7da3`](https://github.com/juspay/hyperswitch-control-center/commit/07a7da348b91a81dbff39a7640bd887942dd7245))
- Close mobile sidebar when navigating to profile from user menu ([#4288](https://github.com/juspay/hyperswitch-control-center/pull/4288)) ([`dde6f9f`](https://github.com/juspay/hyperswitch-control-center/commit/dde6f9f4e5d7a34758152a255265d0302f582c7e))
- Prevent filter dropdown from closing on Select All checkbox icon click ([#4295](https://github.com/juspay/hyperswitch-control-center/pull/4295)) ([`be37a88`](https://github.com/juspay/hyperswitch-control-center/commit/be37a8892740ed1760aded4e14d0b16316ffc452))
- Validate duplicate profile name on create and rename ([#4289](https://github.com/juspay/hyperswitch-control-center/pull/4289)) ([`772d8bd`](https://github.com/juspay/hyperswitch-control-center/commit/772d8bd3b1e2149f5bd19d99d7c1def2a2ce013f))
- Align globalSearch in orchestrator V1 with feature flag ([#4282](https://github.com/juspay/hyperswitch-control-center/pull/4282)) ([`541e6de`](https://github.com/juspay/hyperswitch-control-center/commit/541e6de7b0d0734efcccc9a124d23b72f28aa74c))
- Redirect bug for dispute from payment details page ([#4293](https://github.com/juspay/hyperswitch-control-center/pull/4293)) ([`3030ec8`](https://github.com/juspay/hyperswitch-control-center/commit/3030ec80032dcf29ea95af77e6b9a0322934b872))

**Full Changelog:** [`2026.03.03.0...2026.03.04.0`](https://github.com/juspay/hyperswitch-control-center/compare/2026.03.03.0...2026.03.04.0)
...
**Full Changelog:** [`2026.02.02.0...2026.02.03.0`](https://github.com/juspay/hyperswitch-control-center/compare/2026.01.30.0...2026.02.03.0)
...
- Recon engine entry details with account level grouping ([#4167](https://github.com/juspay/hyperswitch-control-center/pull/4167)) ([`315086b`](https://github.com/juspay/hyperswitch-control-center/commit/315086b6f16cceeddd64c5a401941a811ff62e62))

### Miscellaneous Tasks

- Added Hyperswitch Error description column in more payments ([#4155](https://github.com/juspay/hyperswitch-control-center/pull/4155)) ([`4c475ca`](https://github.com/juspay/hyperswitch-control-center/commit/4c475cac9afef8145cf2b9e877eb1d867145c40c))
- Bank debit and additional PMT refactor ([#4159](https://github.com/juspay/hyperswitch-control-center/pull/4159)) ([`071348e`](https://github.com/juspay/hyperswitch-control-center/commit/071348e80d1987047f6ca9519d6cb98e68a550b1))
- Warning modal in embedded connector home ([#4161](https://github.com/juspay/hyperswitch-control-center/pull/4161)) ([`fbdbc19`](https://github.com/juspay/hyperswitch-control-center/commit/fbdbc192754861d15410d24c941722ec14f3f171))

**Full Changelog:** [`2026.01.29.0...2026.02.02.0`](https://github.com/juspay/hyperswitch-control-center/compare/2026.01.29.0...2026.02.02.0)
...
- Embeddable bank debit PMT ([#4108](https://github.com/juspay/hyperswitch-control-center/pull/4108)) ([`ccbc34a`](https://github.com/juspay/hyperswitch-control-center/commit/ccbc34a195b887df6bad533562f68f25c2190e76))
- Disable dummy and test connector for embeddable components ([#4155](https://github.com/juspay/hyperswitch-control-center/pull/4155)) ([`10496f7`](https://github.com/juspay/hyperswitch-control-center/commit/10496f7a92d3e4781b74200341d12cf4d52a08d3))

**Full Changelog:** [`2026.01.28.0...2026.01.29.0`](https://github.com/juspay/hyperswitch-control-center/compare/2026.01.28.0...2026.01.29.0)
...
- Cardbin types and validation fixes ([#4148](https://github.com/juspay/hyperswitch-control-center/pull/4148)) ([`84e0c5c`](https://github.com/juspay/hyperswitch-control-center/commit/84e0c5cf5d79f6a8fa5197ca194e42f5f576e172))

### Miscellaneous Tasks

- Recon engine hierarchical transactions and exceptions pagination ui ([#4124](https://github.com/juspay/hyperswitch-control-center/pull/4124)) ([`c79cef0`](https://github.com/juspay/hyperswitch-control-center/commit/c79cef0ddd3edfd37be70584ad393a6d5980fa0a))

**Full Changelog:** [`2026.01.25.0...2026.01.28.0`](https://github.com/juspay/hyperswitch-control-center/compare/2026.01.25.0...2026.01.28.0)
...
- Enable payjustNow and payjustNowstore in prod ([#4144](https://github.com/juspay/hyperswitch-control-center/pull/4144)) ([`806f225`](https://github.com/juspay/hyperswitch-control-center/commit/806f225500cc0c7b41c42b9d9927eb8fd56498e2))

### Miscellaneous Tasks

- Hide unused fields in payment link ([#4150](https://github.com/juspay/hyperswitch-control-center/pull/4150)) ([`fefad39`](https://github.com/juspay/hyperswitch-control-center/commit/fefad393889458b5a4f8954de56ec0210133fca0))
- Feature additions in orchestration v2 ([#4126](https://github.com/juspay/hyperswitch-control-center/pull/4126)) ([`12b5518`](https://github.com/juspay/hyperswitch-control-center/commit/12b55181fd555865d011685dc1e0d17115b21048))

**Full Changelog:** [`2026.01.23.0...2026.01.25.0`](https://github.com/juspay/hyperswitch-control-center/compare/2026.01.23.0...2026.01.25.0)
...
- Redesigned additional details flow ([#3939](https://github.com/juspay/hyperswitch-control-center/pull/3939)) ([`3b0579e`](https://github.com/juspay/hyperswitch-control-center/commit/3b0579eb26d42b8b61ea4c23abff3b419e6488c0))
- Added theme list page ([#3893](https://github.com/juspay/hyperswitch-control-center/pull/3893)) ([`55013a6`](https://github.com/juspay/hyperswitch-control-center/commit/55013a6ea728310238b59eb617d7adcff76f72ab))

**Full Changelog:** [`2025.12.24.1...2025.12.30.0`](https://github.com/juspay/hyperswitch-control-center/compare/2025.12.24.1...2025.12.30.0)
...
- Added amazonpay wallet fields ([#3933](https://github.com/juspay/hyperswitch-control-center/pull/3933)) ([`3e90988`](https://github.com/juspay/hyperswitch-control-center/commit/3e9098867e406e39640553a9613ca526421edbc8))
- Add `transaction_view` in payout operations ([#3974](https://github.com/juspay/hyperswitch-control-center/pull/3974)) ([`e25931c`](https://github.com/juspay/hyperswitch-control-center/commit/e25931ce197b39baca4099737aa4df61bd7cb013))

### Bug Fixes

- Fixed theme sidebar bugs ([#3959](https://github.com/juspay/hyperswitch-control-center/pull/3959)) ([`ba6b0bd`](https://github.com/juspay/hyperswitch-control-center/commit/ba6b0bd8ff3d9151e4a6891aeb1194ce6c1bc87e))
- Payment settings v2 - show vault tab only if business profile has vault ([#3953](https://github.com/juspay/hyperswitch-control-center/pull/3953)) ([`f5687c5`](https://github.com/juspay/hyperswitch-control-center/commit/f5687c579906a929d1bb3880f9555916780ff764))

### Miscellaneous Tasks

- Added extended auth related fields in more payments section ([#3932](https://github.com/juspay/hyperswitch-control-center/pull/3932)) ([`0c2038d`](https://github.com/juspay/hyperswitch-control-center/commit/0c2038df62ab8d448c14a53d4ac5050b710aeda6))
- Payment link wasm files path updated ([#3983](https://github.com/juspay/hyperswitch-control-center/pull/3983)) ([`844a5be`](https://github.com/juspay/hyperswitch-control-center/commit/844a5be89e32aa09dc213d30bf582b4720fc7972))

**Full Changelog:** [`2025.12.12.0...2025.12.15.0`](https://github.com/juspay/hyperswitch-control-center/compare/2025.12.12.0...2025.12.15.0)
...
- Wasm changes for vault connector ([#3872](https://github.com/juspay/hyperswitch-control-center/pull/3872)) ([`ee951ff`](https://github.com/juspay/hyperswitch-control-center/commit/ee951ffa37c80f1d6e7243c63f28b61368f77e2d))
- Add support for `vault connector` type ([#3870](https://github.com/juspay/hyperswitch-control-center/pull/3870)) ([`30863d1`](https://github.com/juspay/hyperswitch-control-center/commit/30863d1151b5e052b485bcb5b53cb95e81f39b19))
- Enable peach payments in prod ([#3912](https://github.com/juspay/hyperswitch-control-center/pull/3912)) ([`e0daea9`](https://github.com/juspay/hyperswitch-control-center/commit/e0daea985d460006cebd4b30566ae6463e53a80a))
- Configure pmts - add minimum and maximum amount ([#3900](https://github.com/juspay/hyperswitch-control-center/pull/3900)) ([`3dbefe4`](https://github.com/juspay/hyperswitch-control-center/commit/3dbefe4bb3ae48bc6845ea58408f55afe56e3062))
- Enable zift connector in prod ([#3915](https://github.com/juspay/hyperswitch-control-center/pull/3915)) ([`f4719ca`](https://github.com/juspay/hyperswitch-control-center/commit/f4719ca26fa730ae64785eef67a3a5ad9e5afd5d))

### Bug Fixes

- Sidebar active product click bugfix ([#3902](https://github.com/juspay/hyperswitch-control-center/pull/3902)) ([`7d16ae1`](https://github.com/juspay/hyperswitch-control-center/commit/7d16ae119ccc775b900594009ed4b24e7365d8ec))

### Miscellaneous Tasks

- Remove decrypted(predecrypt) flow in apple pay and google pay … ([#3894](https://github.com/juspay/hyperswitch-control-center/pull/3894)) ([`394356c`](https://github.com/juspay/hyperswitch-control-center/commit/394356c42741d4ebbc62360bea688183766fe49c))

**Full Changelog:** [`2025.11.26.1...2025.11.28.0`](https://github.com/juspay/hyperswitch-control-center/compare/2025.11.26.1...2025.11.28.0)
...
- Domain name payment settings ([#3684](https://github.com/juspay/hyperswitch-control-center/pull/3684)) ([`570df8a`](https://github.com/juspay/hyperswitch-control-center/commit/570df8ae81ed450e6f0f96f6d955c0d9fd39361f))
- Recon engine add `download` functionality in ingestion ([#3775](https://github.com/juspay/hyperswitch-control-center/pull/3775)) ([`edf963c`](https://github.com/juspay/hyperswitch-control-center/commit/edf963c2f5fcdb5fe7141d6e571315c195063640))

### Bug Fixes

- Fixed long name not properly visible in tooltip ([#3791](https://github.com/juspay/hyperswitch-control-center/pull/3791)) ([`12e899c`](https://github.com/juspay/hyperswitch-control-center/commit/12e899c0cca2d983f603fd3f89306f544c133de5))

**Full Changelog:** [`2025.11.04.0...2025.11.04.1`](https://github.com/juspay/hyperswitch-control-center/compare/2025.11.04.0...2025.11.04.1)
...
- **WebHook:** Added search option for Event_id ([#3744](https://github.com/juspay/hyperswitch-control-center/pull/3744)) ([`613403b`](https://github.com/juspay/hyperswitch-control-center/commit/613403b24831bbea659100603a5dd4a284d6cb92))
- Custom roles User module ([#3448](https://github.com/juspay/hyperswitch-control-center/pull/3448)) ([`6f84d08`](https://github.com/juspay/hyperswitch-control-center/commit/6f84d08b1651976e47c907e85c71eb325de43a3b))
- Recon engine replace entry exception resolution ([#3766](https://github.com/juspay/hyperswitch-control-center/pull/3766)) ([`4232dd7`](https://github.com/juspay/hyperswitch-control-center/commit/4232dd7e286171d0388d6ea4e9659406d40571df))
- Add `date_filter` to recon overview summary ([#3780](https://github.com/juspay/hyperswitch-control-center/pull/3780)) ([`4d883cc`](https://github.com/juspay/hyperswitch-control-center/commit/4d883cc422dd7a02580f79f48b1e35342a61bebf))
- Addition of billing processors in orchestrator ([#3763](https://github.com/juspay/hyperswitch-control-center/pull/3763)) ([`a90b35e`](https://github.com/juspay/hyperswitch-control-center/commit/a90b35efb84668619ef7171e4fdf1324988699ac))
- Add html input dom bindings ([#3790](https://github.com/juspay/hyperswitch-control-center/pull/3790)) ([`1766ade`](https://github.com/juspay/hyperswitch-control-center/commit/1766ade36a574bc48172965b71ef3c15b5eb9e5e))

### Miscellaneous Tasks

- **deps:** Update rescript-webapi and react-dom to latest versions ([#3672](https://github.com/juspay/hyperswitch-control-center/pull/3672)) ([`e14d0aa`](https://github.com/juspay/hyperswitch-control-center/commit/e14d0aa57be7ad21d03cd5c93a19e3e130b07bed))
- Updated version for @headlessui/react ([#3741](https://github.com/juspay/hyperswitch-control-center/pull/3741)) ([`ffdec27`](https://github.com/juspay/hyperswitch-control-center/commit/ffdec27424d7d0e8f2c4bcd1a61d11ce756bfbeb))
- Move Gateway icons to assets folder and update references ([#3681](https://github.com/juspay/hyperswitch-control-center/pull/3681)) ([`3470846`](https://github.com/juspay/hyperswitch-control-center/commit/3470846409c1ab166cf9061f2073fe0841221006))
- Update the versions of framer-motion ,highcharts and js-sha256 … ([#3678](https://github.com/juspay/hyperswitch-control-center/pull/3678)) ([`0906407`](https://github.com/juspay/hyperswitch-control-center/commit/0906407a4e3e688a4e6fe561a30b10687ab4df47))

**Full Changelog:** [`2025.10.31.0...2025.11.04.0`](https://github.com/juspay/hyperswitch-control-center/compare/2025.10.31.0...2025.11.04.0)
