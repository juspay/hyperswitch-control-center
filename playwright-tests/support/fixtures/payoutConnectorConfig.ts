...
export const payoutConnectorConfig: Record<string, ConnectorConfig> = {
  ...
  adyenplatform: {
    ...
    fields: {
      ...
      fieldLabels: ["Adyen platform's API Key *", "Source verification key"],
    },
    paymentSections: {
      BankTransfer: {
        label: "Bank Transfer",
  ...
  gigadat: {
    ...
    fields: {
      ...
      fieldLabels: ["Access Token *", "Campaign ID *", "Security Token *"],
    },
    paymentSections: {
      BankRedirect: {
        label: "Bank Redirect",
  ...
  loonio: {
    ...
    fields: {
      ...
      fieldLabels: ["Merchant ID *", "Merchant Token *"],
    },
    paymentSections: {
      BankRedirect: {
        label: "Bank Redirect",
  ...
  nomupay: {
    ...
    fields: {
      ...
      fieldLabels: ["Nomupay kid *", "Nomupay eid *"],
    },
    paymentSections: {
      BankTransfer: {
        label: "Bank Transfer",
  ...
  wise: {
    ...
    paymentSections: {
      BankTransfer: {
        label: "Bank Transfer",
        methods: ["ach", "bacs", "sepa_bank_transfer"],
      },
    },
  },
  ...
  worldpayxml: {
    ...
    fields: {
      ...
      fieldLabels: ["API Username *", "API Password *", "Merchant Code *"],
    },
    paymentSections: {
      Credit: {
        label: "Credit",
