...
This file defines the data structures for your page.
   ...
   -   **File Path:** `src/<folderName>/<folderName>Type.res` (e.g., `src/MyNewPage/MyNewPageType.res`)
   -   **Content:**
       ```rescript
...
This file contains the logic for table rendering and data mapping.
   ...
   -   **File Path:** `src/<folderName>/<folderName>Entity.res` (e.g., `src/MyNewPage/MyNewPageEntity.res`)
   -   **Content Structure:**
       ```rescript
