...
let make = (
  ...
  let (title, subTitle) = isLiveMode
    ? (
        "Set Up Payment Processor Reference",
        "Enter the same processor ID used in your subscription platform.",
      )
    : (
        "Configure Retry Logic",
        "Set how and when you'd like retries to be attempted. You can modify this later.",
      )
