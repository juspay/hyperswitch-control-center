    ...
    let handleEventMessage = (ev: Dom.event) => {
      ...
      | Some(dict) => {
          let optionalEventName =
            dict->Js.Dict.get("eventType")->Belt.Option.flatMap(Js.Json.decodeString)
