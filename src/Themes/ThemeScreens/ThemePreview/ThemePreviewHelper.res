...
let renderOrgTiles = (~sidebarFromForm: HyperSwitchConfigTypes.sidebarConfig, orgs) => {
  <div
...
let renderNavbar = () =>
  <div className="flex flex-row gap-8 justify-between items-center w-full p-2">
    <div
      ...
      <span className="ml-1 font-semibold text-nd_gray-500"> {"Test_profile"->React.string} </span>
