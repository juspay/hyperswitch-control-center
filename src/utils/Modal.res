    ...
    <AddDataAttributes attributes=[("data-component", `modal` ++ attributeId)]>
      {noBackDrop
        ...
        : <div
            ...
            className={`${mobileClass} ${displayClass} ${overlayBgStyle} fixed h-screen w-screen ${zIndexClass} ${modalPosition} ${paddingClass} flex ${alignModal} inset-0 ${backgroundDropStyles}`}>
            children
          </div>}
    </AddDataAttributes>
  }
