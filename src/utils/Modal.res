    ...
    <AddDataAttributes attributes=[("data-component", `modal` ++ attributeId)]>
      {noBackDrop
        ...
        : <div
            ...
            className={`${mobileClass} ${displayClass} ${overlayBgStyle} fixed h-screen w-modalOverlay -left-14 ${zIndexClass} ${modalPosition} ${paddingClass} flex ${alignModal} inset-0 overflow-auto ${backgroundDropStyles}`}>
            children
          </div>}
    </AddDataAttributes>
  }
