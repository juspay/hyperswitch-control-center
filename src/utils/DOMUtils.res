...
type window = {mutable _env_: HyperSwitchConfigTypes.appUrlConfig}
type embeddableWindow = {mutable _env_: HyperSwitchConfigTypes.embeddableUrlConfig}
...
@val external embeddableWindow: embeddableWindow = "window"
