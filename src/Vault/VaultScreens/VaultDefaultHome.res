  ...
  <div className="flex flex-1 flex-col w-full gap-14 items-center justify-center h-screen">
    ...
    <div className="flex flex-col gap-8 items-center">
      ...
      <PageHeading
        ...
        subTitle="Learn how to vault cards from your Server if you're PCI compliant and learn how to vault cards using the Checkout SDK if you're non-PCI compliant"
      />
    </div>
