...
let make = () => {
  ...
  <div className="mt-10 flex flex-col gap-2">
    ...
    <div className="font-medium text-nd_gray-400 w-3/4">
      {"Network Tokenization enables secure card storage and seamless future transactions, with Juspay as the Token Requestor–Token Service Provider (TR-TSP)."->React.string}
