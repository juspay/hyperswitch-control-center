...
let make = () => {
  ...
  <div>
    <PageUtils.PageHeading
      title={"Surcharge Processor"} subTitle={"Connect and configure Surcharge Processor"}
    />
      ...
      <div className="flex flex-col gap-8">
        <RenderIf condition={configuredConnectors->Array.length > 0}>
          <LoadedTable
            ...
            resultsPerPage=20
            entity={SurchargeProcessorEntity.surchargeProcessorEntity(
              "surcharge-processor",
        ...
        <ProcessorCards
          ...
          connectorsAvailableForIntegration=ConnectorUtils.surchargeProcessorList
