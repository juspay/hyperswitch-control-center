...
module SearchBarFilter = {
  ...
  let make = (~placeholder, ~setSearchVal, ~searchVal) => {
    ...
    <div className="px-4 w-120 flex">
      {InputFields.textInput(
        ~input=inputSearch,
        ~placeholder,
        ~inputStyle="border-t border-blue-450 focus:border-blue-600",
        ~customStyle=`!h-10 w-full rounded-full hover:bg-blue-100 px-3`,
      ...
      //          buttonType={SelectTransparent}
      //          customButtonStyle="mt-2 "
      //          customIconSize=13
      //          onClick={_ => {
      //            setSearchVal(_ => searchValBase)
      //          }}
