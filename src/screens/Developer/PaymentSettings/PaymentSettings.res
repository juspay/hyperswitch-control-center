            ...
            render={({handleSubmit}) => {
              <form
                ...
                <DesktopRow wrapperClass="!flex-col">
                  ...
                  />
                  <div className="ml-1 font-medium text-fs-14 text-jp-gray-text_muted">
                    {"Network Tokenization will be enabled for your merchant account with Juspay as Token Requestor-Token Service Provider (TR-TSP), providing secure and seamless card storage for future transactions. To enable this feature, please contact us on "->React.string}
                    <a
