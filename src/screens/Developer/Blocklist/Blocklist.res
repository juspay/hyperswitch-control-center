  ...
  <div className="flex flex-col">
    ...
    <section className="max-w-3xl py-8 flex flex-col gap-4">
      <div className="flex items-start justify-between gap-4">
        <div>
          <p className={`${body.lg.semibold} text-nd_gray-700`}> {"Upload CSV"->React.string} </p>
      ...
      <RenderIf condition={selectedFile->Option.isSome}>
        <div
          ...
          <Icon
            name="trash-alt" className="cursor-pointer text-nd_gray-500" onClick=resetSelectedFile
          />
        </div>
      </RenderIf>
