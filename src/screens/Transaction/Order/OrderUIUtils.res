    ...
    <RenderIf condition={sampleData && !previewOnly}>
      <div className="flex items-start">
        ...
        <ACLDiv
          height="h-fit"
          authorization={userHasAccess(~groupAccess=OperationsManage)}
          className="bg-gray-50 hover:bg-gray-150 hover:text-jp-gray-890  focus:outline-hidden border-border_gray cursor-pointer p-2.5 overflow-hidden text-gray-900/75 hover:text-black
