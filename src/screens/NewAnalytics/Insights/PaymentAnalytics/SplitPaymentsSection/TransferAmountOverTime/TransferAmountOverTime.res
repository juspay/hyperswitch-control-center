...
module TableModule = {
  ...
  let make = (~data, ~className="") => {
    ...
    let visibleColumns = [Total_Transfer_Amount, Time_Bucket, Connector]
    ...
    <div className>
      <LoadedTable
        ...
        entity=InsightsPaymentAnalyticsEntity.transferAmountOverTimeTableEntity
        resultsPerPage=10
...
module TransferAmountOverTimeHeader = {
  @react.component
...
let make = (
  ...
  let params = {
    data: chartData,
    xKey: Total_Transfer_Amount->getStringFromVariant,
