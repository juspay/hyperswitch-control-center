...
let make = (
  ...
  let (userDropOffRateData, setUserDropOffRateData) = React.useState(_ => JSON.Encode.array([]))
  ...
  let getPaymentsProcessed = async () => {
    ...
    try {
      ...
      if primaryData->Array.length > 0 {
        ...
        setUserDropOffRateData(_ => primaryModifiedData->Identity.genericTypeToJson)
