...
open ExemptionRequestRateUtils
...
let make = (
  ...
  let (exemptionRequestData, setExemptionRequestRateData) = React.useState(_ =>
    JSON.Encode.array([])
  )
  ...
  let getPaymentsProcessed = async () => {
    ...
    try {
      ...
      if primaryData->Array.length > 0 {
        ...
        setExemptionRequestRateData(_ => primaryModifiedData->Identity.genericTypeToJson)
