...
let make = (
  ...
  let customUI =
    <NoDataFound
      message={isResolved ? "No resolved alerts found" : "No alerts found"} renderType={Painting}
    />
  ...
  <PageLoaderWrapper screenState customUI>
    <LoadedTableWithCustomColumns
      ...
      showAutoScroll=true
      isDraggable=true
      visitedRows={{getId: alert => alert.id, prefix_key: isResolved ? "resolved-alert" : "alert"}}
    />
  </PageLoaderWrapper>
}
