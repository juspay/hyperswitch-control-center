module RoutingApproachDistribution = {
  @react.component
  let make = () => {
    open APIUtils
    open LogicUtils
    ...
    <PageLoaderWrapper screenState customUI={<InsightsHelper.NoData />}>
      <div className="flex flex-col">
        <div
          className="border rounded-xl py-2 px-4 border-nd_gray-200 rounded-b-none bg-nd_gray-25">
...
module ConnectorVolumeDistribution = {
  @react.component
  let make = () => {
    open APIUtils
    open LogicUtils
...
let make = () => {
  <div>
    ...
    <div className="grid xl:grid-cols-2 gap-2 grid-cols-1">
      <ConnectorVolumeDistribution />
      <RoutingApproachDistribution />
    </div>
  </div>
}
