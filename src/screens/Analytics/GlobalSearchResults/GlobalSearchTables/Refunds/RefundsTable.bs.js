...
function RefundsTable$PreviewTable(props) {
  var tableData = props.data
    ...
    .map(function (item) {
      return RefundsTableEntity.tableItemToObjMapper(item);
    });
  return React.createElement(LoadedTable.make, {
    ...
    title: RefundsTableEntity.domain,
...
function RefundsTable(props) {
  ...
  var pageDetail = Core__Option.getOr(
    pageDetailDict[RefundsTableEntity.domain],
    defaultValue,
  );
  ...
  var clearPageDetails = function () {
    ...
    newDict[RefundsTableEntity.domain] = defaultValue;
