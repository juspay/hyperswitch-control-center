  ...
  let downloadData = () => {
    ...
    try {
      ...
      let data = rawData->Array.map(item => {
        ...
        newDict->Dict.set("payout_link_id", dict->getvalFromDict("payout_link_id")->Option.getOr(JSON.Encode.null))
        ...
        newDict->Dict.set("confirm", dict->getvalFromDict("confirm")->Option.getOr(JSON.Encode.null))
        ...
        newDict->Dict.set("unified_code", dict->getvalFromDict("unified_code")->Option.getOr(JSON.Encode.null))
        newDict->Dict.set("unified_message", dict->getvalFromDict("unified_message")->Option.getOr(JSON.Encode.null))
        ...
        newDict->Dict.set("additional_payout_method_data", dict->getvalFromDict("additional_payout_method_data")->Option.getOr(JSON.Encode.null))
