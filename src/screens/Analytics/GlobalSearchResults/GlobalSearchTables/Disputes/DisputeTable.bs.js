...
function DisputeTable$PreviewTable(props) {
  var tableData = props.data
    ...
    .map(function (item) {
      return DisputeTableEntity.tableItemToObjMapper(item);
    });
  return React.createElement(LoadedTable.make, {
    ...
    title: DisputeTableEntity.domain,
...
function DisputeTable(props) {
  ...
  var pageDetail = Core__Option.getOr(
    pageDetailDict[DisputeTableEntity.domain],
    defaultValue,
  );
  ...
  var clearPageDetails = function () {
    ...
    newDict[DisputeTableEntity.domain] = defaultValue;
