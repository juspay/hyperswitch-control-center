...
import * as HighchartPieChart from "../../../../components/CustomCharts/HighchartPieChart.bs.js";
import * as PieChartPerformanceUtils from "./PieChartPerformanceUtils.bs.js";

function PieChartPerformance(props) {
  ...
  var chartFetch = async function () {
    try {
      ...
      var options = PieChartPerformanceUtils.getDontchartOptions(
        entity.chartConfig,
        configData,
      );
  ...
  return React.createElement(React.Fragment, {
    children: Caml_option.some(
      React.createElement(HighchartPieChart.RawPieChart.make, {
        options: match[0],
      }),
    ),
  });
