...
let make = (
  ...
  <div>
    <div
      className={`w-min p-3 bg-gray-25 dark:bg-gray-900 rounded-sm border border-gray-250 dark:border-gray-800 align-center justify-center rounded-t-none flex ${directionClass}`}>
      <span>
                          ...
                          React.cloneElement(
                            React.cloneElement(
                              <span
                                ...
                                className={`flex ${directionClass} p-3 m-1 bg-gray-25 dark:bg-gray-900 rounded-sm border border-gray-250 dark:border-gray-800 align-center justify-center rounded-t-none`}>
                                {React.string(str)}
                              </span>,
