...
function SelectBox$ListItem(props) {
  ...
  var optionTextSize =
    !isDropDown && optionSize === "Large" ? "text-fs-16" : "text-base";
...
function SelectBox$BaseSelect(props) {
  ...
  var searchInputUI = React.createElement(
    "div",
    {
      className: customSearchStyle + " pb-0",
    },
    React.createElement(
      "div",
      {
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(Button.make, {
              buttonState:
                noOfSelected !== options.length ? "Normal" : "Disabled",
              text: "SELECT ALL",
          ...
          React.createElement(
            ...
            React.createElement(Button.make, {
              buttonState:
                noOfSelected !== 0 && showClearAll ? "Normal" : "Disabled",
              text: "CLEAR ALL",
              buttonType: "NonFilled",
              buttonSize: "Small",
              customButtonStyle: "w-32 text-fs-11 mx-1",
  ...
  return React.createElement(
    ...
    hasApplyButton
      ...
      : React.createElement(RenderIf.make, {
          condition: isDropDown && noOfSelected > 0 && showSelectCountButton,
...
function SelectBox$BaseDropdown(props) {
  ...
  var __defaultLeftIcon = props.defaultLeftIcon;
  var __disableSelect = props.disableSelect;
  ...
  var disableSelect = __disableSelect !== undefined ? __disableSelect : false;
  var defaultLeftIcon =
    __defaultLeftIcon !== undefined ? __defaultLeftIcon : "NoIcon";
  ...
  var match$4;
  if (allowMultiSelect) {
    match$4 = [buttonText, defaultLeftIcon, ""];
  } else {
