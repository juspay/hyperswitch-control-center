...
let make = (
  ...
  let editButtons =
    <div className="flex items-center pr-2">
      <button onClick={_ => handleCancel()} className="p-1 cursor-pointer text-red-600">
        <Icon name="close" size=12 />
      </button>
      <button onClick={_ => handleSave()} className="p-1 cursor-pointer text-green-600">
      ...
      <div
        ...
        <div className="flex-1">
          <input
            ...
            autoFocus=true
            className="w-full px-4 py-2 bg-transparent focus:outline-none text-md"
          />
        </div>
        {editButtons}
      </div>
