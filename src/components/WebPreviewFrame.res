...
let make = (~children) => {
  <div
    ...
    />
    <div className="relative overflow-hidden max-w-full w-[749px] h-[460px]">
      <div
        className="absolute top-0 left-0 bg-white rounded-xl shadow-2xl border border-nd_gray-200 overflow-hidden origin-top-left w-[960px] h-[590px] scale-[0.78]">
        ...
        <div className="bg-white overflow-hidden h-[540px]"> {children} </div>
      </div>
    </div>
  </div>
}
