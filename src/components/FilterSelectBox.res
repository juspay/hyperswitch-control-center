...
module BaseSelect = {
  ...
  let make = (
    ...
    let borderClass = if !hideBorder {
      if isDropDown {
        `bg-white border dark:bg-gray-900 border-jp-gray-steel/75 dark:border-gray-800 
            rounded-lg rounded-b-none animate-textTransition transition duration-400`
      } else if showToggle {
        "bg-white border rounded-sm rounded-b-none dark:bg-jp-gray-darkgray_background border-jp-gray-steel/75 dark:border-gray-800"
      } else {
        ""
      }
    } else {
