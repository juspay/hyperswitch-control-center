...
let make = (
  ...
  <div
    className={`flex flex-1 flex-row justify-center overflow-auto bg-gray-50/20 rounded-md border select-none ${calendarContaierStyle}`}>
    {dummyRow
    ->Array.mapWithIndex((_item, i) => {
      ...
      let iconClass = "inline-block text-gray-300 dark:text-gray-50/25 cursor-pointer"
      ...
      <div key={Int.toString(i)}>
        <div className="flex flex-row justify-between items-center p-3">
          ...
          <AddDataAttributes attributes=[("data-calendar-date", monthAndYear)]>
            <div className="font-medium text-sm md:text-base text-gray-800 dark:text-gray-50/75">
