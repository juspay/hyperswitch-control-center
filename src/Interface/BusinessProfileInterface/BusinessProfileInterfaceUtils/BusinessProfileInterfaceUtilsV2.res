...
let mapV1WebhookDetailsToCommonType: webhookDetails_v2 => BusinessProfileInterfaceTypes.webhookDetails = webhookDetailsRecord => {
  {
...
let mapV1AuthConnectorDetailsToCommonType: option<authConnectorDetailsType_v2> => option<
