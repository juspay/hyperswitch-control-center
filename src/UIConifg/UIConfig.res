...
let defaultUIConfig: t = {
  ...
  button: {
    ...
    backgroundColor: {
      ...
      primaryDisabled: "bg-button-primary-bg primary-gradient-button opacity-60 dark:bg-gray-900/50 dark:border-gray-950/50 focus:outline-hidden",
      primaryNoHover: "bg-button-primary-bg  hover:bg-button-primary-hoverbg focus:outline-hidden dark:text-gray-50/50 text-gray-800/50 focus:outline-hidden",
