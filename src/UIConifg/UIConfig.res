...
let defaultUIConfig: t = {
  ...
  button: {
    ...
    backgroundColor: {
      primaryNormal: "border-1.5 border-double border-transparent text-button-primary-text primary-gradient-button focus:outline-hidden",
      primaryDisabled: "bg-button-primary-bg primary-gradient-button opacity-60 dark:bg-jp-gray-950 dark:bg-opacity-50 dark:border-jp-gray-disabled_border dark:border-opacity-50 focus:outline-hidden",
      primaryNoHover: "bg-button-primary-bg  hover:bg-button-primary-hoverbg focus:outline-hidden dark:text-opacity-50 text-opacity-50",
      primaryLoading: "bg-button-primary-bg focus:outline-hidden",
      primaryOutline: "mix-blend-normal border-primary focus:outline-hidden",
      paginationNormal: "font-medium border-transparent text-nd_gray-500  focus:outline-hidden text-nd_gray-500",
      ...
      secondaryNormal: "border-1.5 border-double border-transparent text-button-secondary-text secondary-gradient-button focus:outline-hidden",
      secondaryDisabled: "bg-button-secondary-bg secondary-gradient-button focus:outline-hidden",
      secondaryNoBorder: "hover:bg-jp-gray-lightmode_steelgray hover:bg-opacity-40 dark:bg-jp-gray-darkgray_background dark:text-jp-gray-text_darktheme dark:text-opacity-50 dark:hover:bg-jp-gray-950 focus:outline-hidden",
      secondaryLoading: "bg-button-secondary-bg  dark:bg-jp-gray-darkgray_background focus:outline-hidden",
      secondaryNoHover: "bg-button-secondary-bg text-opacity-50 hover:bg-button-secondary-hoverbg dark:bg-jp-gray-darkgray_background dark:text-jp-gray-text_darktheme focus:outline-hidden dark:text-opacity-50 ",
    },
    borderRadius: {
      default: "rounded",
