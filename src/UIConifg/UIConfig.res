...
let defaultUIConfig: t = {
  ...
  button: {
    ...
    backgroundColor: {
      ...
      primaryDisabled: "bg-button-primary-bg primary-gradient-button opacity-60 dark:bg-jp-gray-950/50 dark:border-jp-gray-disabled_border/50",
      ...
      paginationDisabled: "border-left-1 border-right-1 font-normal border-left-1  dark:bg-jp-gray-950/50  dark:border-jp-gray-disabled_border/50",
      paginationNoHover: "font-medium text-primary/1 hover:text-primary/70 bg-primary/10 border-transparent font-medium  dark:text-jp-gray-text_darktheme/75",
