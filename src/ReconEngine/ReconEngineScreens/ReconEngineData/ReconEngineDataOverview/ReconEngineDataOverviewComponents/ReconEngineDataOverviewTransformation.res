...
let make = (
  ...
  let detailsFields: array<ReconEngineDataSourcesEntity.transformationHistoryColType> = [
    TransformationName,
    TransformationHistoryId,
    TransformationStats,
    TransformedAt,
            ...
            ->Array.map(
              colType => {
                <DisplayKeyValueParams
                  ...
                  heading={ReconEngineDataSourcesEntity.getTransformationHistoryHeading(colType)}
                  value={ReconEngineDataSourcesEntity.getTransformationHistoryCell(config, colType)}
                />
              },
            )
            ->React.array}
