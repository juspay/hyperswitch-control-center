...
let sourceConfigLabelToString = (label: ReconEngineDataSourcesTypes.sourceConfigLabel): string => {
  switch label {
...
): array<ReconEngineDataSourcesTypes.sourceConfigDataType> => {
  let sourceConfigData: array<ReconEngineDataSourcesTypes.sourceConfigDataType> = [
    {
...
): ReconEngineDataSourcesTypes.fileTimelineState => {
...
): ReconEngineDataSourcesTypes.timelineConfig => {
  switch state {
  | FileAccepted => {
