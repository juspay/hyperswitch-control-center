...
let make = (~config: ReconEngineTypes.ingestionConfigType, ~isUploading) => {
  ...
  let topFilterUi = {
    <div className="flex flex-row">
      <DynamicFilter
        title="ReconEngineDataSourcesHistoryFilters"
        ...
        tabNames=filterKeys
        key="ReconEngineDataSourcesHistoryFilters"
  ...
  <div className="flex flex-col gap-4 my-4">
    ...
    <PageLoaderWrapper screenState>
      <LoadedTable
        ...
        entity={ReconEngineDataSourcesHistoryTableEntity.ingestionHistoryTableEntity(
