...
let make = (~config: ReconEngineTypes.transformationConfigType) => {
  open LogicUtils
  open ReconEngineDataTransformationUtils
  ...
  let topFilterUi = {
    <div className="flex flex-row">
      <DynamicFilter
        title="ReconEngineDataTransformationHistoryFilters"
        ...
        tabNames=filterKeys
        key="ReconEngineDataTransformationHistoryFilters"
  ...
  <div className="flex flex-col gap-4 my-4">
    ...
    <PageLoaderWrapper screenState>
      <LoadedTable
        ...
        entity={ReconEngineDataTransformationHistoryTableEntity.transformationHistoryTableEntity(
