...
let make = (~config: ReconEngineTypes.transformationConfigType) => {
  ...
  <div
    className="relative border rounded-xl px-6 py-1 mt-8 grid 2xl:grid-cols-4 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 items-start gap-y-8 gap-x-20">
    <div
