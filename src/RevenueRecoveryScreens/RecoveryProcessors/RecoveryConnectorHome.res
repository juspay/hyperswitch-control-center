            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-x-3 px-6">
                <Icon
                  ...
                  customHeight="20"
                />
                <GatewayIcon gateway={connector->String.toUpperCase} className="w-7 h-7" />
                <h1 className="text-medium font-semibold text-gray-600">
                  {`Setup ${connector->getDisplayNameForConnector}`->React.string}
                </h1>
              </div>
              <RecoveryConfigurationHelper.RecoveryConfigurationCurrentStepIndicator
                currentStep stepsArr={RecoveryPaymentProcessorsUtils.stepsArr}
              />
            </div>
          </div>
