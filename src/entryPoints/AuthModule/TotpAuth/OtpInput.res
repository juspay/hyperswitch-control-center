...
module InputFieldForOtp = {
  ...
  let make = (~inputRef, ~value, ~index, ~handleChange, ~handleFocus) => {
    let inputClass = `text-center h-full w-full border border-jp-2-light-gray-600 rounded-lg outline-none focus:border-blue-500 focus:shadow-focusBoxShadow text-2xl`
