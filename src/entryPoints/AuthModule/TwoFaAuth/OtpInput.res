...
module InputFieldForOtp = {
  ...
  let make = (~inputRef, ~value, ~index, ~handleChange, ~handleFocus) => {
    let inputClass = `text-center h-full w-full border border-jp-2-light-gray-600 rounded-lg outline-hidden focus:border-primary focus:shadow-focusBoxShadow text-2xl overflow-hidden`
