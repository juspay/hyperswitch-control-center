  ...
  let make = (~totpUrl, ~isQrVisible) => {
    <>
        ...
        <div className="flex flex-col gap-10 col-span-3">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4 ml-2">
              <p className="text-fs-15 font-medium opacity-60 flex gap-3 items-center">
                <div className="text-black bg-blue-100 border border-blue-200 px-2 py-0.5 rounded-[28%] w-6 text-center">
                  {"1"->React.string}
                </div>
      ...
      <div className="flex items-center my-4">
        ...
        <span className="text-fs-15 mx-4 opacity-90 text-gray-500 whitespace-nowrap">
