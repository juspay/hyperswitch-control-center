  ...
  let make = (~totpUrl, ~isQrVisible) => {
    <>
      <div className="grid grid-cols-4 gap-4 w-full">
        <div className="flex flex-col gap-10 col-span-3">
          <div className="flex flex-col gap-4">
            ...
            <div className={`${body.lg.medium} text-nd_gray-600 flex flex-col gap-4 ml-2`}>
              <p className="flex gap-3 items-center">
                <div
                  className="bg-nd_gray-50 border border-nd_br_gray-150 px-1 rounded-md w-6 text-center">
                  {"1"->React.string}
                </div>
        ...
        <div
          className={`flex flex-col gap-2 col-span-1 items-center justify-center  ${totpUrl->isNonEmptyString
              ? "blur-none"
              : "blur-sm"}`}>
      ...
      <div className="flex items-center my-4">
        <div className="flex-grow h-px bg-nd_gray-150" />
