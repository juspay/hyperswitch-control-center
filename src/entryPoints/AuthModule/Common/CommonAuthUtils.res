...
let clearLocalStorage = () => {
  ...
  LocalStorage.clear()
  HyperSwitchEntryUtils.setEmailToStore(emaill) // Preserve email in login page
  ...
  HyperSwitchEntryUtils.setCustomTableHeaders(customTableColumns) // Preserve tableColumnsOrder in login page
}
