...
let make = () => {
  ...
  | ACCEPT_INVITATION_FROM_EMAIL => featureFlagDetails.devAcceptInvite? {<AcceptInviteScreenV2 onClick=onClickErrorPageButton />} : {<AcceptInviteScreen onClick=onClickErrorPageButton />}
