...
module GetProductionAccess = {
  ...
  let make = () => {
    ...
    | Some(_) =>
      <div
        className={`flex items-center gap-2 border ${borderColor} bg-white text-gray-700  ${cursorStyles} px-3 py-10-px mb-4 whitespace-nowrap rounded-lg justify-between`}
        onClick={_ => {
          isProdIntent
            ? ()
            : {
        ...
        <div className={`text-gray-600 ${textStyles} !font-semibold`}>
...
module ProductHeaderComponent = {
  ...
  let make = () => {
    ...
    <div className={`text-xs font-semibold px-3 py-2 text-gray-400 tracking-widest`}>
