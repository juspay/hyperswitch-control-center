...
export function convertCurrency(amount, from_currency, to_currency) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    wasm.convertCurrency(
      retptr,
      amount,
      addHeapObject(from_currency),
      addHeapObject(to_currency),
    );
    var r0 = getInt32Memory0()[retptr / 4 + 0];
    var r1 = getInt32Memory0()[retptr / 4 + 1];
    var r2 = getInt32Memory0()[retptr / 4 + 2];
...
export function getRequestPayload(input, response) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    wasm.getRequestPayload(
      retptr,
      addHeapObject(input),
      addHeapObject(response),
    );
    var r0 = getInt32Memory0()[retptr / 4 + 0];
    var r1 = getInt32Memory0()[retptr / 4 + 1];
    var r2 = getInt32Memory0()[retptr / 4 + 2];
...
function __wbg_get_imports() {
  ...
  imports.wbg.__wbg_fromCodePoint_5aced4409dbb8969 = function () {
    return handleError(function (arg0) {
